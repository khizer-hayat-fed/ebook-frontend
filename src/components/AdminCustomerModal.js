...
import { useAddCustomerMutation, useUpdateCustomerMutation  } from '../store/adminsSlice';

const AdminCustomerModal = ({ show, handleClose, title, data, isManager, refetchAgain }) => {
    ...
    const handleSave = async () => {
        try {
            ...
            if (data) {
                await updateCustomer({ email, userId: data._id });
                toast.success("Customer updated successfully");
            } else {
                await addCustomer({ email, password, type });
